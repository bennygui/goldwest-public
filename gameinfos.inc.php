...
$gameinfos = array(
    ...
    'tie_breaker_description' => totranslate(
        "In the case of a tie, the tied player with the fewest Camp Pieces in the Wanted area is the winner. If players are still tied, the tied player with the most resources remaining in their Supply Track is the winner. If players are still tied after that, a rematch is in order!"
    ),
    ...
    'player_colors' => array('f07f16', '982fff', '0000ff', 'ffffff'),
